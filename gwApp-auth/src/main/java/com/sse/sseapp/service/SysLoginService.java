...
import com.sse.sseapp.core.enums.UserStatus;
...
import com.sse.sseapp.core.utils.ip.IpUtils;
...
public class SysLoginService {
    ...
    public LoginUser login(String username, String password) {
        ...
        // 查询用户信息
        R<LoginUser> userResult = sysUserFeign.info(username);
    ...
    public void register(String username, String password) {
        ...
        R<?> registerResult = sysUserFeign.register(sysUser);
