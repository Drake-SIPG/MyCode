...
/**
 * @author: liuxinyu
 * @create-date: 2023/5/25 11:15
 */
@TableName("app_project_kcbtb_subscription")
@Data
@EqualsAndHashCode(callSuper = true)
@Accessors(chain = true)
public class SysProjectKCBTBSubscription extends BaseEntity<SysProjectKCBTBSubscription> {
