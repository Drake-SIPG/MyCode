...
/**
 * @author: liuxinyu
 * @create-date: 2023/5/25 11:38
 */
@TableName("app_project_merge_subscription")
@Data
@EqualsAndHashCode(callSuper = true)
@Accessors(chain = true)
public class SysProjectMergeSubscription extends BaseEntity<SysProjectMergeSubscription> {
