package com.sse.sseapp.jpush.image;
...
import com.sse.sseapp.jpush.image.model.ImageFilePayload;
import com.sse.sseapp.jpush.image.model.ImageSource;
import com.sse.sseapp.jpush.image.model.ImageUploadResult;
import com.sse.sseapp.jpush.image.model.ImageUrlPayload;
...
public class ImageClient {
    ...
    public ImageUploadResult uploadImage(ImageFilePayload imageFilePayload) {
        ...
        LOG.info("upload fileMap: {}", fileMap);
        String response = client.formUploadByPost(url, textMap, fileMap, null);
        LOG.info("upload image result: {}", response);
    ...
    public ImageUploadResult modifyImage(String mediaId, ImageFilePayload imageFilePayload) {
        ...
        Map<String, String> fileMap = imageFilePayload.toFileMap();
        LOG.info("upload image fileMap: {}", fileMap);
