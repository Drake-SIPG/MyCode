package com.sse.sseapp.jpush.push.model.audience;
...
import com.sse.sseapp.jpush.push.model.PushModel;
...
public class Audience implements PushModel {
    ...
    public static Audience tagNot(String...tagValue) {
        AudienceTarget target = AudienceTarget.tag_not(tagValue);
        return newBuilder().addAudienceTarget(target).build();
    }

    public static Audience tagNot(Collection<String> tagValues) {
