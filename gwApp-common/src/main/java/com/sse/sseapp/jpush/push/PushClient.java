package com.sse.sseapp.jpush.push;
...
import com.sse.sseapp.jpush.push.model.BatchPushResult;
import com.sse.sseapp.jpush.push.model.EncryptKeys;
import com.sse.sseapp.jpush.push.model.EncryptPushPayload;
...
public class PushClient {
    ...
    public CIDResult getCidList(int count, String type) throws APIConnectionException, APIRequestException {
        ...
        Preconditions.checkArgument(type == null || "push".equals(type) || "schedule".equals(type), "type should be \"push\" or \"schedule\"");
