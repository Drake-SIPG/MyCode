 ...
 */
@RestController
@RequestMapping("/dataStore/system/menu")
public class SysMenuController extends BaseController {
    ...
    public AjaxResult roleMenuTreeSelect(@RequestParam("roleId") Long roleId, @RequestParam("userId") Long userId) {
    ...
    public AjaxResult getRouters(@PathVariable("userId") Long userId) {
