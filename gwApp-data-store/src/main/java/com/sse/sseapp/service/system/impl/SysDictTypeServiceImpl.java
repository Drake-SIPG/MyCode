...
import com.sse.sseapp.mapper.system.SysDictTypeMapper;
...
public class SysDictTypeServiceImpl implements ISysDictTypeService {
    ...
    @Override
    public SysDictType getInfoByType(String dictType) {
        return dictTypeMapper.getInfoByType(dictType);
    }
    /**
     * 项目启动时，初始化字典到缓存
     */
    ...
    public int insertDictType(SysDictType dict) {
        //设置保存字典类型UUID  根据SnowUtils类获取UUID并转换为Long类型

        dict.setDictId(SnowUtils.bigKey());
